...
export class MobileAppsComponent extends PropertiesModel implements OnInit, OnDestroy {
  ...
  addNew(): void {
    this.router.navigate(['/admin/add-new'], { queryParams: { propertyType: 'app', orgType: 'commercial', appSection: 'support', type: 'properties' } });
  }
  ...
  editItem(ev: any): void {
    this.router.navigate(['/admin/add-new'], {state: ev, queryParams: { propertyType: 'app', orgType: 'commercial', appSection: 'support', type: 'properties', editMode: 'true' } });
  }

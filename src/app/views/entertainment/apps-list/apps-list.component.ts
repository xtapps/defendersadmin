...
@Component({
  selector: 'app-entertainment-apps-list',
...
export class AppsListComponent extends PropertiesModel implements OnInit, OnDestroy {
  ...
  getAppslIst(): void {
    ...
    this.subscription.push(
      this.adminService.getEntertainmentApps(this.limit, this.offset, this.searchText).subscribe((res: any) => {
        this.isLoading = false;
        this.appsList = res.apps;
